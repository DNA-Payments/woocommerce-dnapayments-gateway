...
const ErrorMessage = ({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
    ...
    children: messages.length > 1 ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("ul", {
      style: {
        marginBottom: 0
      },
      children: messages.map((message, i) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("li", {
        children: message
      }, i))
    }) : messages[0]
  });
...
/* harmony import */ var _common_errors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../common/errors */ "./client/common/errors.js");
/* harmony import */ var _common_log__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../common/log */ "./client/common/log.js");
/* harmony import */ var _common_try_parse__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../common/try-parse */ "./client/common/try-parse.js");
/* harmony import */ var _common_validater__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../common/validater */ "./client/common/validater.js");
/* harmony import */ var _common_complete_payment__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../common/complete-payment */ "./client/common/complete-payment.js");
/* harmony import */ var _common_debounce__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../common/debounce */ "./client/common/debounce.js");
/* harmony import */ var _common_payment_component_helper__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../common/payment-component-helper */ "./client/common/payment-component-helper.js");
...
/* harmony import */ var _utils_get_settings__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/get-settings */ "./client/blocks/utils/get-settings.js");
/* harmony import */ var _utils_get_payment_data__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/get-payment-data */ "./client/blocks/utils/get-payment-data.js");
/* harmony import */ var _error_message__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./error-message */ "./client/blocks/components/error-message.js");
...
const PaymentComponent = ({
  ...
  const [loadingState, setLoadingState] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)('idle');
  const [errorMessages, setErrors] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)([]);

  // pay button container
  const containerRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  // full payment data
  const paymentDataRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  // preliminary payment data
  const draftPaymentDataRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  // resolve and reject of onBeforeProcessPayment
  const processPromiseRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  // resolve and reject of onCheckoutSuccess
  const checkoutPromiseRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  const {
    tempToken
  } = _utils_get_settings__WEBPACK_IMPORTED_MODULE_10__.dnaPaymentsSettingsData;
  const paymentDataJSON = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    try {
      return JSON.stringify((0,_utils_get_payment_data__WEBPACK_IMPORTED_MODULE_11__.getPaymentData)(props));
    } catch (err) {
      (0,_common_log__WEBPACK_IMPORTED_MODULE_3__.logError)(err);
      return '{}';
    }
  }, [props]);
  const rejectCheckoutPromise = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => {
    if (checkoutPromiseRef.current) {
      checkoutPromiseRef.current.resolve({
        type: responseTypes.ERROR,
        message: _common_errors__WEBPACK_IMPORTED_MODULE_2__["default"].CARD_PAYMENT_FAIL.message,
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const handler = payload => {
      const messages = (0,_common_validater__WEBPACK_IMPORTED_MODULE_5__.validatePaymentData)(draftPaymentDataRef.current);
      (0,_common_log__WEBPACK_IMPORTED_MODULE_3__.logData)('onCheckoutValidation', payload, messages);
      if (messages.length) {
  ...
  const setupIntegration = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useCallback)((0,_common_debounce__WEBPACK_IMPORTED_MODULE_7__.debounce)(async () => {
    setLoadingState('loading');
    containerRef.current.innerHTML = '';
    componentInstance.create(containerRef.current, draftPaymentDataRef.current, {
      onClick: () => {
        setLoadingState('loading');
        return {
      ...
      onBeforeProcessPayment: () => new Promise((resolve, reject) => {
        processPromiseRef.current = {
          resolve,
          reject
        };
        (0,_utils_place_order_button__WEBPACK_IMPORTED_MODULE_9__.triggerPlaceOrderButtonClick)();
      }),
      onPaymentSuccess: async paymentResult => {
        (0,_common_log__WEBPACK_IMPORTED_MODULE_3__.logData)('onPaymentSuccess', paymentResult);
        const redirect = paymentDataRef.current?.paymentSettings?.returnUrl;
        await (0,_common_complete_payment__WEBPACK_IMPORTED_MODULE_6__.completePayment)({
          paymentResult,
          redirect,
          setErrors
        });
      ...
      onError: err => {
        const message = (0,_common_payment_component_helper__WEBPACK_IMPORTED_MODULE_8__.getPaymentComponentErrorMessage)(err, errorMessage);
        setLoadingState('failed');
        setErrors(Array.isArray(message) ? message : [message]);
        if ((0,_common_payment_component_helper__WEBPACK_IMPORTED_MODULE_8__.isProcessFailed)(err)) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const handler = ({
      ...
      checkoutPromiseRef.current = {
        resolve,
        reject
      };
      const paymentData = (0,_common_try_parse__WEBPACK_IMPORTED_MODULE_4__.tryParse)(paymentDetails.paymentData);
      const auth = (0,_common_try_parse__WEBPACK_IMPORTED_MODULE_4__.tryParse)(paymentDetails.auth);
      if (paymentData && auth) {
        ...
        processPromiseRef.current?.reject(_common_errors__WEBPACK_IMPORTED_MODULE_2__["default"].CARD_PAYMENT_FAIL.message);
        rejectCheckoutPromise();
      }
    });
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const handler = async params => {
      (0,_common_log__WEBPACK_IMPORTED_MODULE_3__.logData)('onCheckoutFail', params);
      const {
        processingResponse: {
          message,
          paymentDetails: {
      ...
      const errorMessage = message || messages || _common_errors__WEBPACK_IMPORTED_MODULE_2__["default"].CARD_PAYMENT_FAIL.message;
  ...
  (0,_utils_place_order_button__WEBPACK_IMPORTED_MODULE_9__.useTogglePlaceOrderButtonDisabled)(activePaymentMethod);
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(_error_message__WEBPACK_IMPORTED_MODULE_12__.ErrorMessage, {
      messages: errorMessages
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(LoadingMask, {
...
/***/ "./client/blocks/utils/get-payment-data.js":
/*!*************************************************!*\
  !*** ./client/blocks/utils/get-payment-data.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _common_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../common/utils */ "./client/common/utils.js");
/* harmony import */ var _get_settings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./get-settings */ "./client/blocks/utils/get-settings.js");
...
function getPaymentData(props) {
  ...
  const {
    terminalId
  } = _get_settings__WEBPACK_IMPORTED_MODULE_2__.dnaPaymentsSettingsData;
  const orderLines = props.cartData.cartItems.map(product => {
    var _product$images$0$src;
    const total = getAmount(parseFloat(product.totals.line_subtotal), props);
    const quantity = product.quantity;
    return {
      reference: String(product.id),
      name: (0,_common_utils__WEBPACK_IMPORTED_MODULE_1__.removeNonLatin1)(product.name),
      imageUrl: (_product$images$0$src = product.images?.[0]?.src) !== null && _product$images$0$src !== void 0 ? _product$images$0$src : '',
  ...
  const getValueByKey = key => {
    var _billing$cartTotalIte;
    return getAmount((_billing$cartTotalIte = billing.cartTotalItems.find(item => item.key === key)?.value) !== null && _billing$cartTotalIte !== void 0 ? _billing$cartTotalIte : 0, props);
  };
  return {
    ...
    amountBreakdown: {
      itemTotal: {
        totalAmount: getValueByKey('total_items')
      },
      shipping: {
        totalAmount: getValueByKey('total_shipping')
      },
      taxTotal: {
        totalAmount: getValueByKey('total_tax')
      },
      discount: {
        totalAmount: getValueByKey('total_discount')
      }
    },
    orderLines,
    paymentSettings: {
...
function isPlaceOrderButtonDisabled(activePaymentMethod) {
  return [_constants__WEBPACK_IMPORTED_MODULE_1__.GATEWAY_ID_GOOGLE_PAY, _constants__WEBPACK_IMPORTED_MODULE_1__.GATEWAY_ID_APPLE_PAY].includes(activePaymentMethod);
}
...
/* harmony export */ });
/* harmony import */ var _request__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./request */ "./client/common/api/request.js");
...
async function updateOrderStatus(orderId, paymentResult) {
  ...
  return await (0,_request__WEBPACK_IMPORTED_MODULE_0__.request)('/wp-admin/admin-ajax.php?action=update_order_status', {
    method: 'POST',
    body: formData
  });
}
...
/***/ "./client/common/payment-component-helper.js":
/*!***************************************************!*\
  !*** ./client/common/payment-component-helper.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getPaymentComponentErrorMessage: () => (/* binding */ getPaymentComponentErrorMessage),
/* harmony export */   isInitFailed: () => (/* binding */ isInitFailed),
/* harmony export */   isProcessFailed: () => (/* binding */ isProcessFailed)
/* harmony export */ });
...
function getPaymentComponentErrorMessage(err, initErrorMessage) {
  (0,_log__WEBPACK_IMPORTED_MODULE_0__.logError)(err);
  let message = _errors__WEBPACK_IMPORTED_MODULE_1__["default"].CARD_PAYMENT_FAIL.message;
  if (err.message) {
    message = err.message;
  }
...
const isInitFailed = err => [1002, 1003].includes(err.code); // Failed to initialize / validate the Google / Apple Pay button

const isProcessFailed = err => [1005].includes(err.code); // Failed to process the Google Pay / Apple Pay payment
...
/* harmony import */ var _common_errors__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../common/errors */ "./client/common/errors.js");
...
/* harmony import */ var _components_payment_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/payment-component */ "./client/blocks/components/payment-component.js");
...
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_2__.getPaymentMethodData)(_constants__WEBPACK_IMPORTED_MODULE_7__.GATEWAY_ID_APPLE_PAY, {});
const defaultLabel = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Apple Pay', _constants__WEBPACK_IMPORTED_MODULE_7__.TEXT_DOMAIN);
 ...
 */
const Content = props => {
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.RawHTML, {
...
const ApplePayButton = props => {
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_components_payment_component__WEBPACK_IMPORTED_MODULE_8__.PaymentComponent, {
    componentInstance: window.DNAPayments.ApplePayComponent,
    gatewayId: _constants__WEBPACK_IMPORTED_MODULE_7__.GATEWAY_ID_APPLE_PAY,
    containerId: _constants__WEBPACK_IMPORTED_MODULE_7__.CONTAINER_IDS.applepay,
    errorMessage: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)(_common_errors__WEBPACK_IMPORTED_MODULE_5__["default"].APPLE_PAY_INIT_FAIL.message, _constants__WEBPACK_IMPORTED_MODULE_7__.TEXT_DOMAIN),
    props: props
  });
};
...
const dnapaymentsApplePayPaymentMethod = {
  name: _constants__WEBPACK_IMPORTED_MODULE_7__.GATEWAY_ID_APPLE_PAY,
  label: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(Label, {}),
  content: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(ApplePayButton, {}),
  ...
  canMakePayment: _common_validater__WEBPACK_IMPORTED_MODULE_6__.isApplePayAvailable
};
(0,_common_validater__WEBPACK_IMPORTED_MODULE_6__.checkApplePayAvailability)(_utils_get_settings__WEBPACK_IMPORTED_MODULE_9__.dnaPaymentsSettingsData.terminalConfig).then(isAvailable => {
  if (isAvailable) {
    (0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_0__.registerPaymentMethod)(dnapaymentsApplePayPaymentMethod);
  }
});
})();
