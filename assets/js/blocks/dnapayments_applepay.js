...
/* harmony import */ var _common_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../common/utils */ "./client/common/utils.js");
/* harmony import */ var _common_payment_component_helper__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../common/payment-component-helper */ "./client/common/payment-component-helper.js");
/* harmony import */ var _utils_place_order_button__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/place-order-button */ "./client/blocks/utils/place-order-button.js");
/* harmony import */ var _utils_get_settings__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/get-settings */ "./client/blocks/utils/get-settings.js");
/* harmony import */ var _utils_get_payment_data__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../utils/get-payment-data */ "./client/blocks/utils/get-payment-data.js");
/* harmony import */ var _error_message__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./error-message */ "./client/blocks/components/error-message.js");
...
const PaymentComponent = ({
  ...
  const {
    tempToken,
    isTestMode
  } = _utils_get_settings__WEBPACK_IMPORTED_MODULE_11__.dnaPaymentsSettingsData;
  const paymentDataJSON = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    try {
      return JSON.stringify((0,_utils_get_payment_data__WEBPACK_IMPORTED_MODULE_12__.getPaymentData)(props));
    } catch (err) {
    ...
    componentInstance.init({
      ...
      events: {
        ...
        onBeforeProcessPayment: () => new Promise((resolve, reject) => {
          ...
          (0,_utils_place_order_button__WEBPACK_IMPORTED_MODULE_10__.triggerPlaceOrderButtonClick)();
        }),
        ...
        onError: err => {
          const message = (0,_common_payment_component_helper__WEBPACK_IMPORTED_MODULE_9__.getPaymentComponentErrorMessage)(err, errorMessage);
          setLoadingState('failed');
          setErrors(Array.isArray(message) ? message : [message]);
          if ((0,_common_payment_component_helper__WEBPACK_IMPORTED_MODULE_9__.isProcessFailed)(err)) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const handler = ({
      ...
      if (paymentData && auth) {
        paymentData.merchantCustomData = (0,_common_utils__WEBPACK_IMPORTED_MODULE_8__.addGatewayId)(paymentData.merchantCustomData, gatewayId);
  ...
  (0,_utils_place_order_button__WEBPACK_IMPORTED_MODULE_10__.useTogglePlaceOrderButtonDisabled)(activePaymentMethod);
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(_error_message__WEBPACK_IMPORTED_MODULE_13__.ErrorMessage, {
      messages: errorMessages
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(LoadingMask, {
...
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_2__.getPaymentMethodData)(_common_constants__WEBPACK_IMPORTED_MODULE_7__.GATEWAY_ID_APPLE_PAY, {});
const defaultLabel = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Apple Pay', _common_constants__WEBPACK_IMPORTED_MODULE_7__.TEXT_DOMAIN);
...
const ApplePayButton = props => {
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_components_payment_component__WEBPACK_IMPORTED_MODULE_8__.PaymentComponent, {
    ...
    gatewayId: _common_constants__WEBPACK_IMPORTED_MODULE_7__.GATEWAY_ID_APPLE_PAY,
    containerId: _common_constants__WEBPACK_IMPORTED_MODULE_7__.CONTAINER_IDS.applepay,
    errorMessage: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)(_common_errors__WEBPACK_IMPORTED_MODULE_5__["default"].APPLE_PAY_INIT_FAIL.message, _common_constants__WEBPACK_IMPORTED_MODULE_7__.TEXT_DOMAIN),
    props: props
  });
};
...
const dnapaymentsApplePayPaymentMethod = {
  name: _common_constants__WEBPACK_IMPORTED_MODULE_7__.GATEWAY_ID_APPLE_PAY,
